  ...
  const mockOrganizations = [
    {
      ...
      description: 'Российская транснациональная компания в отрасли информационных технологий',
      industry: 'Technology',
    ...
    },
    {
      ...
      name: 'Сбербанк',
      organization_type: 'COMPANY',
      description: 'Крупнейший банк России и один из ведущих международных финансовых институтов',
      industry: 'Finance',
      organization_size: '1000+',
      address_city: 'Москва',
      address_country: 'Россия',
    ...
    },
    {
      ...
      organization_type: 'COMPANY',
      description: 'Международная компания, работающая в сфере информационной безопасности',
      industry: 'Technology',
    ...
    },
    {
      ...
      name: 'Газпром',
      organization_type: 'COMPANY',
      description: 'Российская энергетическая компания, крупнейшая в мире по добыче газа',
      industry: 'Energy',
      organization_size: '1000+',
    ...
    },
    {
      ...
      name: 'Mail.ru Group',
      organization_type: 'COMPANY',
      description: 'Российская интернет-компания, один из лидеров рынка интернет-услуг',
      industry: 'Technology',
      organization_size: '500-1000',
      address_city: 'Москва',
      address_country: 'Россия',
