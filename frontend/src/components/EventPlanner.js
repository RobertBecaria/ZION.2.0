                  ...
                  {loadingWishList ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      {wishListData.wishes.map((wishItem) => {
                        const isPink = selectedEvent.birthday_party_data.theme === 'PINK';
                        ...
                        return (
                          <button
                            key={wishItem.index}
                            onClick={() => !isClaimed || isClaimedByMe ? handleClaimWish(selectedEvent.id, wishItem.index) : null}
                    ...
                    // Fallback to original display if API fails
