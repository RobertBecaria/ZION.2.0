        ...
        <div className="modal-body">
          ...
          {selectedEvent.event_type === 'BIRTHDAY' && selectedEvent.birthday_party_data && (
            ...
            >
              ...
              {/* Use WishListDisplay component for wish list with claim functionality */}
              <WishListDisplay
                event={selectedEvent}
                wishListData={wishListData}
                loadingWishList={loadingWishList}
                claimingWish={claimingWish}
                handleClaimWish={handleClaimWish}
              />
            </div>
          )}
    ...
    <div className="modal-overlay" onClick={() => { setShowCreateModal(false); resetEventForm(); }}>
      <div className="create-event-modal" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleCreateEvent}>
          ...
          {/* Birthday Party Form Section - Using extracted component */}
          {newEvent.event_type === 'BIRTHDAY' && (
            <BirthdayPartyForm
              birthdayPartyData={birthdayPartyData}
              setBirthdayPartyData={setBirthdayPartyData}
              wishInput={wishInput}
              setWishInput={setWishInput}
              addWish={addWish}
              removeWish={removeWish}
              classmates={classmates}
              loadingClassmates={loadingClassmates}
              selectedClassmates={selectedClassmates}
              toggleClassmateSelection={toggleClassmateSelection}
              newEvent={newEvent}
            />
          )}
  ...
  return (
    <div className="event-planner" style={{ '--module-color': moduleColor }}>
      ...
      <div className="planner-content">
        ...
        {/* Upcoming Events Sidebar - Using extracted component */}
